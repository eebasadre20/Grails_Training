			...
			<ol class="property-list album">
				...
				<li class="fieldcontain">
					<span id="songs-label" class="property-label"><g:message code="album.songs.label" default="Songs" /></span>
						...
						<span class="property-value" aria-labelledby="songs-label"><g:link controller="song" action="show" id="${s.id}">${s?.title?.encodeAsHTML()}</g:link></span>
						</g:each>
				...
				<li class="fieldcontain">
					<span id="store-label" class="property-label"><g:message code="album.store.label" default="Store" /></span>
						...
						<span class="property-value" aria-labelledby="store-label"><g:link controller="store" action="show" id="${albumInstance?.store?.id}">${albumInstance?.store?.name?.encodeAsHTML()}</g:link></span>
